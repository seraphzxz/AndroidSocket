...
#include<string.h>
//第一步：导入Socket编程的标准库
#include<sys/types.h> //这个标准库：linux数据类型(size_t、time_t等等......)
#include<sys/socket.h> //提供socket函数及数据结构
#include<netinet/in.h> //数据结构(sockaddr_in)
#include<arpa/inet.h> //ip地址的转换函数
...
Java_com_example_seraphzxz_androidsocket_network_SocketClient_connectByJni
